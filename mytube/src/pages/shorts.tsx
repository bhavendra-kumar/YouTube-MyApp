            ...
            >
              <div className="relative aspect-[9/16] h-full max-h-[calc(100dvh-56px-var(--yt-bottom-nav-h)-24px)] md:max-h-[calc(100dvh-56px-24px)] w-full max-w-[420px] overflow-hidden rounded-2xl bg-black">
                ...
                <div className="absolute right-3 bottom-[calc(5rem+env(safe-area-inset-bottom)+var(--yt-bottom-nav-h))] md:bottom-20 flex flex-col items-center gap-4 text-white">
                  <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} aria-label="Like" onClick={() => toggleLike(id)}>
                    <ThumbsUp
                      className={`h-6 w-6 ${
                        liked.has(id)
                  ...
                  <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} aria-label="Dislike" onClick={() => toggleDislike(id)}>
                    <ThumbsDown
                      className={`h-6 w-6 ${
                  ...
                  <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} aria-label="Comments" onClick={() => setOpenComments(id)}>
                  ...
                  <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} aria-label="Share" onClick={() => setShareOpenFor(id)}>
